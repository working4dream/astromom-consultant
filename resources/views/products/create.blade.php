                                    ...
                                    <div class="col-xxl-6 col-md-6">
                                        <div>
                                            ...
                                            <input type="number" class="form-control" id="duration_in_min"
                                                name="duration_in_min" value="{{ old('duration_in_min') }}">
                                    ...
                                    <div class="col-xxl-12 col-md-12">
                                        <div>
                                            <label for="description" class="form-label">Description <span
                                                    class="text-danger">*</span></label>
                                            <textarea type="text" class="form-control ckeditor-classic" id="description" name="description"></textarea>
                                            @error('description')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-xxl-12 col-md-12">
                                        <div>
                                            ...
                                            <input type="number" class="form-control" id="price" name="price"
                                                value="{{ old('price') }}" min="0" pattern="\d*"
                                        ...
                                        <div>
                                            ...
                                            <div class="form-check form-switch form-switch-lg" dir="ltr">
                                                <input id="is_gst_checkbox" name="is_gst" type="checkbox" value="1"
                                                    data-on="1" data-off="0" class="form-check-input">
                                            </div>
                                            @error('is_gst')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#is_gst_checkbox').on('change', function() {
                ...
                $('#total_price_wrapper').toggleClass('d-none', !this.checked);
                calculateTotalPrice();
            });
