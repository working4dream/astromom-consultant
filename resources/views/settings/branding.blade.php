...
<div class="card">
    <div class="card-body">
        <form id="brand_form" action="{{ route('admin.settings.update-branding') }}" method="post" enctype="multipart/form-data">
            @csrf
            ...
            <div class="row gy-4 mt-2">
                ...
                <div class="col-xxl-10 col-md-10">
                    <div>
                        <input type="text" class="form-control" id="primary_color" name="primary_color"
                         value="{{ $settings['primary_color'] ?? '' }}" readonly>
                        @error('primary_color')
                ...
                <div class="col-xxl-10 col-md-10">
                    <div>
                        ...
                        value="{{ $settings['secondary_color'] ?? ''}}" readonly>
                ...
                <div class="col-xxl-10 col-md-10">
                    ...
                    <img id="brand_logo_preview" src="#" style="max-height:100px; margin-top:10px; display:none; border-radius:6px;">
                
                    @if(!empty($settings['brand_logo']))
                        <div class="mt-3 d-flex align-items-center gap-3">
                            <img src="{{ Storage::disk('s3')->temporaryUrl($settings['brand_logo'], now()->addMinutes(30)) }}" style="max-height:100px; border-radius:6px;">
                            
                            <button type="button" class="btn btn-danger btn-sm" onclick="deleteBrandLogo()">
                                <i class="fa fa-trash"></i> Delete
                            </button>
                            
                            <form id="delete_brand_logo_form" action="{{ route('admin.settings.delete-brand-logo') }}" method="POST" style="display:none;">
                                @csrf
                            </form>
                        </div>
                    @endif
            ...
            <div class="row gy-4 mt-2">
                ...
                <div class="col-xxl-9 col-md-10">
                    <button class="btn btn-primary float-end mt-3" onclick="document.getElementById('brand_form').submit();">
