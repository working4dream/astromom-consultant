                    ...
                    <div class="live-preview">
                        <form action="{{ route('admin.coupons.update', $coupon->id) }}" method="post"
                            ...
                            <div class="row gy-4 mt-2">
                                ...
                                <div class="col-xxl-2 col-md-2">
                                    <div>
                                        <label for="expiry_date" class="form-label flatpickr-input">Expiry Date<span
                                                class="text-danger">*</span> </label>
                                    </div>
                                </div>
                                <div class="col-xxl-4 col-md-4">
                                ...
                                <div class="col-xxl-4 col-md-4">
                                    <div>
                                        <input type="text" class="form-control" id="used_counts" name="used_counts"
                                            value="{{ old('used_counts', $coupon->used_counts) }}">
                                        @error('used_counts')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-xxl-4 col-md-4">
                                    <select class="form-control" data-choices data-choices-multiple-groups="true"
                                        ...
                                        @foreach(explode(',',$settings['service_types']) as $service_type)
                                                    <option @if (isset($coupon->used_type) && in_array($service_type, explode(',', $coupon->used_type))) selected @endif value="{{ $service_type }}">
                                                        {{ $service_type }}</option>
                                                @endforeach
                                                @endif
                                    </select>
                                ...
                                <div class="col-xxl-4 col-md-4">
                                    <div>
                                        <div class="form-check form-switch form-switch-lg" dir="ltr">
                                            <input name="active" type="checkbox" value="1" data-on="1"
                                                data-off="0" class="form-check-input" id="customSwitchsizelg"
