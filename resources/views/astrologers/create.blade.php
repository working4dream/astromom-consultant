                ...
                <div class="card-body">
                    <div class="live-preview">
                        <form action="{{ route('admin.experts.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <x-dropzone label="Profile Picture" name="profile_picture" model="Astrologer" />
                            <div class="row gy-4 mt-2">
                                <div class="col-xxl-2 col-md-2">
                                    <div>
                                        ...
                                        <select class="form-control" name="professional_title[]" id="professional_title"
                                            ...
                                            @if ($settings)
                                                @foreach (explode(',', $settings['specialization']) as $sp)
                                                    <option value="{{ $sp }}"
                                                        @if (old('professional_title')) @if (in_array($sp, old('professional_title'))) selected @endif
                                                        @endif>{{ $sp }}
                                                    </option>
                                                @endforeach
                                            @endif
                                        ...
                                        <select class="form-control" name="keywords[]" id="keywords" multiple>
                                            ...
                                            @if ($settings)
                                                @foreach (explode(',', $settings['keywords']) as $sp)
                                                    <option value="{{ $sp }}"
                                                        @if (old('keywords')) @if (in_array($sp, old('keywords'))) selected @endif
                                                        @endif>{{ $sp }}
                                                    </option>
                                                @endforeach
                                            @endif
                                            ...
                                            @if ($settings)
                                                @foreach (explode(',', $settings['languages']) as $language)
                                                    <option value="{{ $language }}"
                                                        {{ collect(old('language', []))->contains($language) ? 'selected' : '' }}>
                                                        {{ $language }}
                                                    </option>
                                                @endforeach
                                            @endif
                            ...
                            <div class="row gy-4 mt-2">
                                ...
                                <div class="col-xxl-10 col-md-10">
                                    <div>
                                        <textarea type="text" class="form-control" id="description" name="description" maxlength="200" onkeyup="updateCharCount()">{{ old('description') }}</textarea>
                                        <small class="char-count mt-1 text-muted">Characters: <span id="charCount">0</span>/200
                                        </small>
                                        @error('description')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-xxl-10 col-md-10">
                                    <div>
                                        <div class="form-check form-switch form-switch-lg" dir="ltr">
                                            <input name="status" type="checkbox" value="0" data-on="1"
                                                data-off="0" class="form-check-input" checked id="customSwitchsizelg">
                                        </div>
                                        @error('active')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
