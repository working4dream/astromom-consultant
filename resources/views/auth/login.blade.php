                        ...
                        <div>
                            <a href="index" class="d-inline-block auth-logo">
                                @if (env('APP_ENV') === 'production')
                                    <img src="{{ URL::asset('images/logo.svg')}}" alt="logo" height="130">
                                @else
                                    <img src="{{ URL::asset('images/logo.png')}}" alt="logo" height="130">
                                @endif
                            </a>
                        </div>
                    </div>
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="p-2 mt-4">
                                <form action="{{ route('admin.login') }}" method="POST">
                                    ...
                                    <div class="mt-4">
                                        <button class="btn btn-soft-secondary w-100" type="submit">Sign In</button>
                                    </div>
                                </form>
                            </div>
                        </div>
